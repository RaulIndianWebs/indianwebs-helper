...
<p>La titularidad de este sitio web <?php echo $site_url; ?>, (en adelante Sitio Web) la ostenta: <?php echo $titular; ?>, con NIF: <?php echo $nif; ?>, y cuyos datos de contacto son:</p>
<ul>
<li>Dirección: <?php echo $direccion; ?></li>
<li>Teléfono de contacto: <?php echo $telefono; ?></li>
<li>Email de contacto: <?php echo $email; ?></li>
</ul>
<p>Este documento (así como otros documentos que aquí se mencionen) regula las condiciones por las que se rige el uso de este Sitio Web (<?php echo $site_url; ?>) y la compra o adquisición de productos y/o servicios en el mismo (en adelante, Condiciones).</p>

<p>A efectos de estas Condiciones se entiende que la actividad que <?php echo $site_name; ?> desarrolla a través del Sitio Web comprende:</p>

<p><?php echo $descripcion_productos; ?></p>

<p>Además de leer las presentes Condiciones, antes de acceder, navegar y/o usar esta página web, el Usuario ha de haber leído el Aviso Legal y las Condiciones Generales de Uso, incluyendo, la política de cookies, y la política de privacidad y de protección de datos de <?php echo $site_name; ?>. Al utilizar este Sitio Web o al hacer y/o solicitar la adquisición de un producto y/o servicio a través del mismo el Usuario consiente quedar vinculado por estas Condiciones y por todo lo anteriormente mencionado, por lo que si no está de acuerdo con todo ello, no debe usar este Sitio Web.</p>
...
<p>El Usuario podrá formalizar, a su elección, con <?php echo $site_name; ?> el contrato de compraventa de los productos y/o servicios deseados en cualquiera de los idiomas en los que las presentes Condiciones estén disponibles en este Sitio Web.</p>

<h2>3. PROCESO DE COMPRA O ADQUISICIÓN</h2>
<p>Los Usuarios debidamente registrados pueden comprar en el Sitio Web por los medios y formas establecidos. Deberán seguir el procedimiento de compra y/o adquisición online de <?php echo $site_url; ?>, durante el cual varios productos y/o servicios pueden ser seleccionados y añadidos al carrito, cesta o espacio final de compra y, finalmente, hacer clic en: "<?php echo $texto_boton_compra; ?>"</p>
...
<p>Seguidamente, el Usuario recibirá un correo electrónico confirmando que <?php echo $site_name; ?> ha recibido su pedido o solicitud de compra y/o prestación del servicio, es decir, la confirmación del pedido. Y, en su caso, se le informará, igualmente, mediante correo electrónico cuando su compra esté siendo enviada. En su caso, estas informaciones también podrían ponerse a disposición del Usuario a través de su espacio personal de conexión al Sitio Web.</p>

<p>Una vez el procedimiento de compra ha concluido, el Usuario consiente que el Sitio Web genere una factura electrónica que se hará llegar al Usuario a través del correo electrónico y en su caso, a través de su espacio personal de conexión al Sitio Web. Asimismo, el Usuario puede, si así lo desea, obtener una copia de su factura en papel, solicitándolo a <?php echo $site_name; ?> utilizando los espacios de contacto del Sitio Web o a través de los datos de contacto facilitados más arriba.</p>
...
<p>Los gastos de envío se encuentran incluidos en los precios finales de los productos tal y como se muestran en el Sitio Web. Así, <?php echo $site_name; ?> realiza los servicios de entrega y/o envío a través de: <?php echo $envio; ?>.</p>
...
<p>Los medios de pago aceptados serán: Tarjeta de crédito o débito, y Transferencia bancaria
<?php echo $site_name; ?> utiliza todos los medios para garantizar la confidencialidad y la seguridad de los datos de pago transmitidos por el Usuario durante las transacciones a través del Sitio Web. Como tal, el Sitio Web utiliza un sistema de pago seguro SSL (Secure Socket Layer).</p>

<p>Las tarjetas de crédito estarán sujetas a comprobaciones y autorizaciones por parte de la entidad bancaria emisora de las mismas, si dicha entidad no autorizase el pago, <?php echo $site_name; ?> no será responsable por ningún retraso o falta de entrega y no podrá formalizar ningún contrato con el Usuario.</p>

<p>Una vez que <?php echo $site_name; ?> reciba la orden de compra por parte del Usuario a través del Sitio Web, se hará una pre-autorización en la tarjeta que corresponda para asegurar que existen fondos suficientes para completar la transacción. El cargo en la tarjeta se hará en el momento en que se envíe al Usuario la confirmación de envío y/o confirmación del servicio que se presta en forma y, en su caso, lugar establecidos.</p>

<p>En todo caso, al hacer clic en "<?php echo $texto_boton_compra; ?>" el Usuario confirma que el método de pago utilizado es suyo.</p>

<p>Los pedidos de compra o adquisición en los que el Usuario seleccione como medio de pago la transferencia bancaria serán reservados durante 5 días naturales a partir de la confirmación del pedido para poder dejar el tiempo suficiente a que la transferencia bancaria sea tomada en cuenta por el sistema de pagos utilizado por <?php echo $site_name; ?> para el Sitio Web. Cuando el sistema recibe la transferencia, el pedido será preparado y gestionado para envío.</p>

<p>Mediante este método de pago, el Usuario debe asegurarse que introduce correctamente el importe exacto del pedido de compra, así como el número de cuenta y la referencia de la transferencia. En caso de error, <?php echo $site_name; ?> no podrá validar el pedido, que será anulado.</p>

<h2>6. ENTREGA</h2>
<p>En los casos en los que proceda realizar la entrega física del bien contratado, las entregas se efectuarán en el ámbito del siguiente territorio: Todo el mundo</p>
...
<p>Los riesgos que de los productos se pudieran derivar serán a cargo del Usuario a partir del momento de su entrega. El Usuario adquiere la propiedad de los productos cuando <?php echo $site_name; ?> recibe el pago completo de todas las cantidades debidas en relación a la compra o adquisición efectuada, incluidos los gastos de envío, o bien en el momento de la entrega, si ésta tiene lugar en un momento posterior a la recepción completa del importe objeto de pago por <?php echo $site_name; ?>.</p>
...
<p>En caso de desistimiento, <?php echo $site_name; ?> reembolsará al Usuario todos los pagos recibidos, incluidos los gastos de envío (con la excepción de los gastos adicionales elegidos por el Usuario para una modalidad de envío diferente a la modalidad menos costosa ofrecida en el Sitio Web) sin ninguna demora indebida y, en todo caso, a más tardar en 14 días naturales a partir de la fecha en la que <?php echo $site_name; ?> es informado de la decisión de desistir por el Usuario.</p>

<p><?php echo $site_name; ?> reembolsará al Usuario utilizando el mismo método de pago que empleó este para realizar la transacción inicial de compra. Este reembolso no generará ningún coste adicional al Usuario. No obstante, <?php echo $site_name; ?> podría retener dicho reembolso hasta haber recibido los productos o artículos de la compra, o hasta que el Usuario presente una prueba de la devolución de los mismos, según qué condición se cumpla primero.</p>

<p>El Usuario puede devolver o enviar los productos a <?php echo $site_name; ?> en: <?php echo $direccion; ?></p>

<p>Y deberá hacerlo sin ninguna demora indebida y, en cualquier caso, a más tardar en el plazo de 14 días naturales a partir de la fecha en que <?php echo $site_name; ?> fue informado de la decisión de desistimiento.</p>
...
<p>En este mismo sentido se rige la prestación de un servicio que el Usuario pudiera contratar en este Sitio Web, pues esta misma Ley establece que no asistirá el Derecho de desistimiento a los Usuarios cuando la prestación del servicio ha sido completamente ejecutada, o cuando haya comenzado, con el consentimiento expreso del consumidor y usuario y con el reconocimiento por su parte de que es consciente de que, una vez que el contrato haya sido completamente ejecutado por <?php echo $site_name; ?>, habrá perdido su derecho de desistimiento.</p>
...
Salvo disposición legal en sentido contrario, <?php echo $site_name; ?> no aceptará ninguna responsabilidad por las siguientes pérdidas, con independencia de su origen:</p>
<ul>
...
<p>Igualmente, <?php echo $site_name; ?> también limita su responsabilidad en cuanto a los siguientes casos:</p>
<ul>
...
<p>De esta forma, las obligaciones quedarán suspendidas durante el periodo en que la causa de fuerza mayor continúe, y <?php echo $site_name; ?> dispondrá de una ampliación en el plazo para cumplirlas por un periodo de tiempo igual al que dure la causa de fuerza mayor. <?php echo $site_name; ?> pondrá todos los medios razonables para encontrar una solución que le permita cumplir con sus obligaciones a pesar de la causa de fuerza mayor.</p>

<h2>10. COMUNICACIONES POR ESCRITO Y NOTIFICACIONES</h2>
Mediante el uso de este Sitio Web, el Usuario acepta que la mayor parte de las comunicaciones con <?php echo $site_name; ?> sean electrónicas (correo electrónico o avisos publicados en el Sitio Web).</p>

<p>A efectos contractuales, el Usuario consiente en usar este medio electrónico de comunicación y reconoce que todo contrato, notificación, información y demás comunicaciones que <?php echo $site_name; ?> envíe de forma electrónica cumplen con los requisitos legales de ser por escrito. Esta condición no afectará a los derechos reconocidos por ley al Usuario.</p>

<p>El Usuario puede enviar notificaciones y/o comunicarse con <?php echo $site_name; ?> a través de los datos de contacto que en estas Condiciones se facilitan y, en su caso, a través de los espacios de contacto del Sitio Web.</p>

<p>Igualmente, salvo que se estipule lo contrario, <?php echo $site_name; ?> puede contactar y/o notificar al Usuario en su correo electrónico o en la dirección postal facilitada.</p>

<h2>11. RENUNCIA</h2>
Ninguna renuncia de <?php echo $site_name; ?> a un derecho o acción legal concreta o la falta de requerimiento por <?php echo $site_name; ?> del cumplimiento estricto por el Usuario de alguna de sus obligaciones supondrá, ni una renuncia a otros derechos o acciones derivados de un contrato o de las Condiciones, ni exonerará al Usuario del cumplimiento de sus obligaciones.</p>

<p>Ninguna renuncia de <?php echo $site_name; ?> a alguna de las presentes Condiciones o a los derechos o acciones derivados de un contrato surtirá efecto, a no ser que se establezca expresamente que es una renuncia y se formalice y se le comunique al Usuario por escrito.</p>
...
<p>Las presentes Condiciones y todo documento al que se haga referencia expresa en estas constituyen el acuerdo íntegro existente entre el Usuario y <?php echo $site_name; ?> en relación con el objeto de compraventa y sustituyen a cualquier otro pacto, acuerdo o promesa anterior convenida verbalmente o por escrito por las mismas partes.</p>

<p>El Usuario y <?php echo $site_name; ?> reconocen haber consentido la celebración de un contrato sin haber confiado en ninguna declaración o promesa hecha por la otra parte, salvo aquello que figura expresamente mencionado en las presentes Condiciones.</p>

<h2>14. PROTECCIÓN DE DATOS</h2>
<p>La información o datos de carácter personal que el Usuario facilite a <?php echo $site_name; ?> en el curso de una transacción en el Sitio Web, serán tratados con arreglo a lo establecido en la Política de Privacidad o de protección de datos (contenida, en su caso, en el Aviso Legal y Condiciones Generales de Uso). Al acceder, navegar y/o usar el Sitio Web el Usuario consiente el tratamiento de dicha información y datos y declara que toda la información o datos que facilita son veraces.</p>
