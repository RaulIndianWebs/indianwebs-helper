...
namespace IW_Helper\Utilities\Features\Shortcodes;
    ...
    foreach ($files as $file) {
        if ($file->isFile() && $file->getExtension() === 'php') {
            ...
            \add_shortcode('iw-' . $file_name, function($atts = [], $content = null) use ($file_path) {
                // Se crea un scope local donde $atts y $content están disponibles
                return (function() use ($file_path, $atts, $content) {
