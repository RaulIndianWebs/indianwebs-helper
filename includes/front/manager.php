...
add_action("Iw_Helper_Load_Frontend",  __NAMESPACE__ . "\\iw_start_cache_system");
...
add_action("Iw_Helper_Load_Frontend",  __NAMESPACE__ . "\\iw_load_cookie_manager");
function iw_load_cookie_manager() {
	include_php_files(get_plugin_directory() . 'includes/cookies-manager/');
}


add_action("Iw_Helper_Load_Frontend",  __NAMESPACE__ . "\\iw_load_helper_modules");
