...
class IW_Helper_Favorite_Plugins extends IW_Helper_form {
    ...
    public function __construct($list) {
        $this->plugins_list = $list;
    }

    public function is_submited() : bool {
        return isset($_POST['bulk_install'])
            && !empty($_POST['bulk_plugins'])
            && check_admin_referer('install_fav_plugin');
    }
        ...
        <div class="wrap">
            <form method="post">
                ...
                <table class="wp-list-table widefat plugins striped">
                    ...
                    <tbody>
                        <?php foreach ( $this->plugins_list as $internal_name => $slug ):
